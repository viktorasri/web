...
<section class="stripe">
    <div class="container">
        <h2>About us</h2>
        <nav><a href="index.php">home</a> > <a href="about.php">about us</a></nav>
    </div>
</section>
...
<section class="about-us-features">
    <div class="container">
        ...
        <div class="wrapper">
            ...
            <h3>BEST services</h3>
            <p>Work with us involve a carefully planned series of steps, centered around a schedule we stick
                daily communication. dolor sit amet, consectetur adipisicing elit. Amet, facere.</p>
        </div>
        <div class="wrapper">
            <div class="circle">
...
<section class="about-us-more">
    <div class="container">
        <div class="why-choose-us">
            <h2>WHY CHOOSE US</h2>
            <div class="we-are-creative">
                <i class="fa fa-chevron-down" aria-hidden="true"></i>
                <p>We are creative</p>
            </div>
            <p class="text-with-border">As a leader in our industry, we have always worked to develop advanced
                technology and innovative methods.</p>
            <ul>
                <li>Proffesional Service</li>
